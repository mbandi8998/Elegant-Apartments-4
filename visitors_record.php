            ...
            <tbody class="text-dark">
                <?php
                    ...
                    while($row = $result->fetch(PDO::FETCH_ASSOC)) {
                        echo '<tr><td>'.$row["First Name"].'</td><td>'.$row["Last Name"].'</td><td>'.$row["ID Number"].'</td><td>'.$row["Phone Number"].'</td><td>'.$row["Host Name"].'</td><td>'.$row["House Number"].'</td><td>'.$row["Sign In Time"].'</td><td>'.$row["Sign Out Time"].'</td></tr>';
